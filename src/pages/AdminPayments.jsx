...
} from "@/components/utils/notificationHelper";
...
export default function AdminPayments() {
  ...
  const filteredPayments = payments.filter((p) => {
    ...
    const matchesPackage =
      packageFilter === "all" || p.package_id === packageFilter;
    const matchesMethod =
  ...
  return (
    ...
    >
          ...
          <CardContent>
            <div className="space-y-3">
              {processedPayments.map((payment) => (
                <div
                  key={payment.id}
                  className="bg-slate-50 rounded-lg p-3 flex flex-col sm:flex-row sm:items-center justify-between gap-3"
                >
                ...
                >
                  ...
                  {adminNotes && (
                    <div
                      ...
                      style={{
                        borderColor:
                          confirmAction === "approve" ? "#c2410c" : "#991b1b",
                      }}
                    >
                      <p
      ...
      <Dialog
        ...
        onOpenChange={() => setViewPaymentDetails(null)}
      >
              ...
              <div className="bg-slate-50 rounded-lg p-4 space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-semibold text-slate-800">
                    ${viewPaymentDetails.amount_usd}
                  </span>
                </div>
                {viewPaymentDetails.currency_code &&
                  viewPaymentDetails.currency_code !== "USD" && (
                    <>
                      <div className="flex justify-between items-center">
                        <span className="text-sm font-medium text-slate-600">
                          Payment Currency:
                      ...
                      {viewPaymentDetails.currency_amount && (
                        <div className="flex justify-between items-center">
                          <span className="text-sm font-medium text-slate-600">
                            Amount ({viewPaymentDetails.currency_code}):
                          </span>
                          <span className="text-sm font-semibold text-blue-600">
                      ...
                      {viewPaymentDetails.exchange_rate && (
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-sm text-slate-500">
                            1 USD ={" "}
                            {viewPaymentDetails.exchange_rate.toLocaleString()}{" "}
                            {viewPaymentDetails.currency_code}
                          </span>
                        </div>
                      )}
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-semibold text-slate-800">
                    {viewPaymentDetails.credits} credits
                  </span>
                </div>
                ...
                {viewPaymentDetails.discount_code && (
                  <>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-sm font-semibold text-orange-600">
                        -${viewPaymentDetails.discount_amount || 0}
                      </span>
                    </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm text-slate-800">
                    {format(
                      new Date(viewPaymentDetails.created_at),
                      "MMM d, yyyy 'at' h:mm a"
                    )}
                  </span>
                </div>
                {viewPaymentDetails.approved_at && (
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm text-slate-800">
                      {format(
                        new Date(viewPaymentDetails.approved_at),
                        "MMM d, yyyy 'at' h:mm a"
                      )}
                    </span>
                  </div>
