...
export const Referral = {
  ...
  apply: (referralCode) => api.post('/referrals/apply', { referral_code: referralCode }),
  filter: async (filters) => {
...
export const User = {
  ...
  adjustCredits: (id, credits, reason) => api.post(`/users/${id}/adjust-credits`, { credits, reason }),
  filter: async (filters) => {
...
export const AI = {
  generateAnalysis: (analysisId) => api.post('/ai/generate-analysis', { analysis_id: analysisId }),
  chat: (message, conversationId, analysisId) => api.post('/ai/chat', {
    message,
    conversation_id: conversationId,
    analysis_id: analysisId
  }),
  invoke: (prompt, system, maxTokens) => api.post('/ai/invoke-llm', { prompt, system, max_tokens: maxTokens }),
};
