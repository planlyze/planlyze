...
export const DiscountCode = {
  ...
  validate: (code, purchaseAmount) => api.post("/discount-codes/validate", { code, purchase_amount: purchaseAmount || 0 }),
...
export const ReportShare = {
  ...
  update: (id, data) => api.put(`/report-shares/${id}`, data),
  delete: (id) => api.delete(`/report-shares/${id}`),
