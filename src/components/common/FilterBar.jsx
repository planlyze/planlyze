...
export const SEARCH_WRAPPER_CLASS = "relative flex-1 min-w-0 sm:min-w-[200px] w-full sm:w-auto";
export const SEARCH_ICON_CLASS = "absolute top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 dark:text-slate-500";
export const SELECT_TRIGGER_CLASS = "h-11 border-2 border-slate-200 dark:border-gray-600 hover:border-purple-400 dark:hover:border-purple-500 bg-white dark:bg-gray-700 dark:text-white w-full sm:w-auto";
export const FILTER_GRID_CLASS = "flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 items-stretch sm:items-center";
